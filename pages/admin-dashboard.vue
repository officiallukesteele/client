    ...
    <main>
      <div class="max-w-7xl mx-auto py-2 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 px-4 py-6 sm:px-0">
          ...
          <div class="px-8 py-8 w-full h-full bg-white shadow rounded-2xl">
            <div
              class="mb-3 w-12 h-12 grid place-content-center rounded-md bg-gradient-to-br from-green-400 to-green-600"
            >
              <i class="fas text-white block fa-dollar-sign"></i>
            </div>
            <h2 class="font-extrabold text-xl leading-10 tracking-tight">
              Payments.
            </h2>
            <p class="text-sm font-bold mt-4 text-green-500 tracking-tight">
              Most Recent
            </p>
            <p
              class="px-6 mt-2 mb-4 text-xs py-2 bg-green-500 text-white rounded-md w-auto md:w-max"
            >
            ...
            <button
              type="button"
              class="inline-flex items-center mt-6 px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
            >
              View more
            </button>
          </div>
